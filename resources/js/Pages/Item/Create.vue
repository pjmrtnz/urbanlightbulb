...
const form = useForm({
    name: '',
    department_id: null // add department_id property to form object
});
...
// find the department with the corresponding id
const department = computed(() => {
    return form.department_id ? departments.find(d => d.id === form.department_id) : null;
});
